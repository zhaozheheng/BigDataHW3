...
if __name__== "__main__":
    ...
    url = 'http://content.guardianapis.com/search?from-date='+ '2019-1-1' +'&to-date='+ '2019-1-1' +'&order-by=newest&show-fields=all&page-size=200&%20num_per_section=10000&api-key='+API_key
